...
//		System.out.println(iter.next());
	...
	private static void m4() {
		...
		// ** p1과 p3를 같은 사람으로 취급하고 싶다. > 어떻게 해야하는지?
		
		
		
		// *** HashSep이 중복값을 체크할 때 equals()와 hashCode()메소드를 사용한다.
	...
	private static void m3() {
		...
		System.out.println(p2.hashCode()); // 메모리 주소값 2036368507
		...
		System.out.println(set); //1, 3 > HaseSet의 반응? > 다른 사람으로 인식
	}
	...
	private static void m1() {
		...
		System.out.println(set.add("바나나")); //false > set은 중복값을 가질 수 없다.
