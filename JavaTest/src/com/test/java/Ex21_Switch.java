...
//		m3();
	...
	private static void m4() throws Exception {
		...
		// 요구사항 : 인터넷 쇼핑몰 > 상품 구매 > 옵션
		// 1. 노트북 + 메모리카드 + 마우스패드 > 변경 > 메모리카드 > USB C타입 케이블
		// 2. 노트북 + 메모리카드
		// 3. 노트북
...
//		}
	...
	private static void m2() throws Exception {
		...
		System.out.println("3. 비타오백");
		System.out.println("---------------");
		System.out.print("선택(번호입력) : ");
		
		String sel = reader.readLine();
		// int로 받는 경우 > 숫자처럼 생겼다고 다 숫자가 아님.
		// 연산을 안하기 때문에 String으로 받아야함.
		
		
		// 문자열 연산자는 == 이 아닌 equals 쓰기
//		if (sel.equals("1")) {
