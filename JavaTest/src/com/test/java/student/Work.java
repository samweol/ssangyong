...
public class Work {
	...
	private void delete() {
		...
		String input = sc.nextLine(); //삭제할 학생 번호(seq)
	...
	private void edit() {
		...
		String input = sc.nextLine(); //수정할 학생 번호(seq)
		...
		if(result != null) {
			...
			System.out.print("수정 : ");
			String name = sc.nextLine(); //입력안하고 엔터치면 ""이 반환
			...
			System.out.println("[나이]" + result.getName());
			System.out.print("수정 : ");
			String age = sc.nextLine(); //입력안하고 엔터치면 ""이 반환
			...
			System.out.println("[성별]" + result.getName());
			System.out.print("수정(1. 남자, 2. 여자) : ");
			String gender = sc.nextLine(); //입력안하고 엔터치면 ""이 반환
			...
			System.out.println("[주소]" + result.getName());
			System.out.print("수정 : ");
			String address = sc.nextLine(); //입력안하고 엔터치면 ""이 반환
	...
	private void view() {
		...
		String input = sc.nextLine(); //학생 번호(seq)
