...
<body>
	<main>
        <div id="login">
            ...
            <div style="margin-bottom: 15px; font-size: 20px; font-weight: bold;">관리자</div>
            <div>
            	<c:if test="${not empty loginError }">
            		<div style="margin-bottom: 5px; color: red;">일치하는 회원 정보가 없습니다.</div>
            	</c:if>
                <form action="/fanimal/main/adminlogin.do" method="post" style="display: flex; flex-direction: column;">
