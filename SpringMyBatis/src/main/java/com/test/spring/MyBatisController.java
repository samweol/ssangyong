...
public class MyBatisController {
	...
	//Spring DI 어노테이션 (의존 주입 어노테이션) -> 원래는 생성자/setter 만들어서 넣었어야했음
	@Autowired
	private MyBatisService service;
	
	//의존주입을 해주는 어노테이션 == xml 에서 bean을 만드는 것과 동일
//	@Autowired
...
//	}
	...
	public String test() {
		...
		System.out.println("1. " + (this.service == null)); //false
	...
	/*
	 * @GetMapping(value="/m1") public String m1(Model model) {
	 * 
	 * return "result"; }
	 */
	...
	public String m2(Model model, String seq) {
		...
		model.addAttribute("result", result); //jsp에 전달
