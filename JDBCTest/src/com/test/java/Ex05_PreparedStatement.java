...
//		m1();
	...
	private static void m2() {
		...
		try {
			...
			//java.sql.SQLException : 인덱스에서 누란된 IN 또는 OUT 매개변수::1
			...
			System.out.print("Ex05_PreparedStatement.m2");
			e.printStackTrace();
		}
	...
	private static void m1() {
		...
		try {
			...
			//- 매개변수값으로 부적절한 값이 있어도 자동으로 이스케이프 시켜준다. (*****)
			...
			System.out.print("Ex05_PreparedStatement.m1");
			e.printStackTrace();
		}
	}
}
