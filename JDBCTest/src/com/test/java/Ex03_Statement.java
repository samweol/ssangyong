...
public class Ex03_Statement {
	...
	private static void m4() {
		...
		try {
			...
			System.out.print("Ex03_Statement.m4");
			e.printStackTrace();
		}
	...
	private static void m3() {
		...
		try {
			...
			System.out.print("Ex03_Statement.m3");
			e.printStackTrace();
		}
	}
	...
	private static void m2() {
		...
		try {
			...
			// ORA-00911: invalid character > ';' 때문에 오류
			...
			System.out.print("Ex03_Statement.m2");
			e.printStackTrace();
		}
	...
	private static void m1() {
		...
		try {
			...
			if (!conn.isClosed()) {
				...
				// stat > SQL 실행 > 어느 DB + 어떤 계정으로 SQL 실행할지는 모르고있음
				stat = conn.createStatement();
			...
			System.out.print("Ex03_Statement.m1");
			e.printStackTrace();
		}
